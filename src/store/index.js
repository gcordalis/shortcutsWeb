...
const store = new Vuex.Store({
  ...
  mutations: {
    addAction (state, { name, icon, actionName, titleColor, bodyColor, iconColor, iconBgColor, methodOptions, requestOptions, time, setting, dontIncludeFileExtension, value, countOptions }) {
